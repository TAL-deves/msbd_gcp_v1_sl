...
app.use(function(req, res, next) {
  res.header("Access-Control-Allow-Origin", ["https://mindschoolbd.com/","https://www.mindschoolbd.com/","mindschoolbd.com"]); // update to match the domain you will make the request from
